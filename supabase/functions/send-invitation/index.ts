        ...
        <html>
          ...
          <body>
            <div class="container">
              ...
              <div style="margin:0 24px 24px;padding:24px;background:#fff;border:1px solid #e5e7eb;border-radius:12px;font-family:Arial,sans-serif;color:#4a4a4a;font-size:13px;line-height:1.6;">
